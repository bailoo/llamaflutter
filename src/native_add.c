...
FFI_PLUGIN_EXPORT intptr_t llama2c(){

    // poor man's C argparse
    char *checkpoint = "/home/abhii/android/native_add/src/tinys.bin";  // e.g. out/model.bin
    ...
    {
        FILE *file = fopen("/home/abhii/android/native_add/src/tokenizer.bin", "rb");
        if (!file) {
